            ...
            <div className="flex items-center gap-4">
              <div className="relative flex h-11 w-11 items-center justify-center rounded-xl border border-[#c8dde8] bg-[#2a8fa0]">
                <div className="relative h-5 w-3">
                  <div className="absolute left-0 bottom-0 h-2 w-[2px] rotate-[-45deg] rounded-full bg-white" />
                  <div className="absolute right-0 top-0 h-5 w-[2px] rotate-[45deg] rounded-full bg-white" />
                </div>
              </div>
              <div>
